    ...
    const testimonials = [
        {
            ...
            name: "Person 1",
            time: "October 3, 2023 at 23:07",
            quote: "Named a Leader in the Gartner® Magic Quadrant™ for Privileged Access Management (PAM) - 5 times in a row."
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/46.jpg",
            name: "Person 2",
            time: "October 3, 2023 at 23:03",
            quote: "Named a Leader in the KuppingerCole Leadership Compass for Privileged Access Management (PAM) - 2 times in a row."
        },
        {
            avatar: "https://randomuser.me/api/portraits/men/86.jpg",
            name: "Person 3",
            time: "October 3, 2023 at 23:09",
            quote: "A Customers' Choice in the Gartner® Peer Insights™ 'Voice of the Customer: Privileged Access Management', 2nd year running        ",
        },
    ]
    return(
        <section className="bg-white py-12">
        <div className="z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                ...
                <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    {
                        testimonials.map((item, idx) => (
                            <li key={idx} className="bg-grey-100 rounded-xl border shadow-md">
                                <div className="p-4">
                                ...
                                <figure>
                                    ...
                                    <div className="flex items-center gap-x-4 p-4 mt-6 bg-indigo-50">
                                        ...
                                        <div>
                                            ...
                                            <span className="block text-gray-500 text-sm mt-0.5">{item.time}</span>
                                        </div>
                                    </div>
                                </figure>
                            </li>
